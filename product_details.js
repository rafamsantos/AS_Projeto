...
const productData = [{
    ...
    },
    {
        ...
        description: "Eleve seu desempenho e estilo com a calça Nike Go Legging. Feita com tecido elástico e de secagem rápida, essa legging proporciona conforto e suporte durante seus treinos. Seu design elegante e estampas vibrantes tornam-na uma escolha versátil para qualquer ocasião esportiva.",
        price: "$29.99",
        type: "calcas",
        condition: "Bom",
    },
    {
        ...
        description: "Experimente o conforto supremo e a elegância com a calça Nike One Luxe. Feita com tecido macio e elástico, essa calça oferece um ajuste perfeito e uma sensação luxuosa ao vestir. Seu design versátil permite transitar facilmente entre atividades esportivas e compromissos do dia a dia, mantendo você sempre estiloso.",
        price: "$39.99",
        type: "calcas",
        condition: "Muito Bom",
    },
    ...
    },
    {
        ...
        description: "Vista-se com o orgulho do Tottenham Hotspur enquanto desfruta do conforto da calça Tech Fleece. Feita com tecido macio e isolante, esta calça oferece uma camada de aquecimento durante os meses mais frios. Apresentando o emblema do Tottenham Hotspur, esta peça permite que você mostre seu apoio ao seu time enquanto mantém um estilo moderno e casual.",
        price: "$49.99",
        type: "calcas",
        condition: "Excelente",
    },
    {
        ...
        description: "Mostre seu amor pelo FC Barcelona enquanto aproveita o conforto da calça Tech Fleece. Feita com tecido macio e isolante, esta calça proporciona calor e conforto durante os dias frios. Com o escudo do FC Barcelona, você pode exibir seu apoio ao clube enquanto mantém um estilo esportivo e moderno.",
        price: "$19.99",
        type: "calcas",
        condition: "Bom"
    },
    {
        ...
        description: "Adicione um toque de estilo esportivo ao seu guarda-roupa com a calça Nike Style. Com um corte moderno e descontraído, essa calça oferece conforto durante todo o dia. Perfeita para um visual casual, ela combina perfeitamente com camisetas e tênis para um estilo urbano e descolado.",
        price: "$34.99",
        type: "calcas",
        condition: "Muito Bom"
    },
    ...
    },
    {
        ...
        description: "Inspirada no estilo e na habilidade do renomado jogador de basquete, ela combina conforto e desempenho. Feita com tecidos de alta qualidade, oferece uma sensação suave e leve. O design moderno e os detalhes exclusivos refletem a personalidade única de Kevin Durant. ",
        price: "$49.99",
        type: "camisolas",
        condition: "Excelente",
    },
    ...
    },
    {
        ...
        description: "Este casaco de fleece da Nike combina conforto e estilo. Seu tecido inovador proporciona isolamento térmico sem adicionar peso extra, tornando-o perfeito para dias frios. Além disso, seu design contemporâneo e ajuste perfeito garantem um visual esportivo e elegante.",
        price: "$69.99",
        type: "casacos",
        condition: "Excelente",
    },
    {
        ...
        description: "Mantenha seu pequeno(a) aquecido(a) e confortável com este casaco Nike Tech Fleece projetado especialmente para crianças. Com um tecido macio e isolante, ele proporciona calor durante o tempo frio, além de um visual moderno e esportivo.",
        price: "$24.99",
        type: "casacos",
        condition: "Bom"
    },
    {
        ...
        description: "Este casaco Nike Tech Fleece é a combinação perfeita de estilo e conforto para as mulheres modernas. Feito com um tecido macio e leve, ele mantém você aquecida em dias frios, enquanto o design feminino e elegante adiciona um toque de sofisticação ao seu visual.",
        price: "$30.99",
        type: "casacos",
        condition: "Bom",
    },
    ...
    },
    {
        ...
        description: "Este casaco da Nike, da linha Dri-FIT Academy, é perfeito para os atletas em busca de desempenho e conforto. Feito com tecido de alta tecnologia, ele proporciona excelente absorção de suor, mantendo você seco e confortável durante os treinos. Com seu design atlético e ajuste perfeito, é uma escolha ideal para os praticantes de esportes.",
        price: "$29.99",
        type: "casacos",
        condition: "Bom",
    },
    ...
    },
    {
        ...
        description: "Este casaco Nike Sportswear Hybrid é uma peça de destaque para os amantes de moda urbana. Combinando elementos esportivos e urbanos, possui um design inovador e versátil. Feito com materiais de alta qualidade, oferece conforto e estilo em todas as ocasiões.",
        price: "$36.99",
        type: "casacos",
        condition: "Muito Bom",
    },
    ...
    },
    {
        ...
        description: "Os tênis Nike Dunk Low são um ícone da moda urbana. Com sua estética retro e design versátil, esses tênis são perfeitos para qualquer ocasião. Com uma variedade de cores e materiais, eles oferecem estilo e personalidade ao seu visual. Além disso, a tecnologia de amortecimento garante conforto durante o uso. Adicione um toque de estilo autêntico ao seu guarda-roupa com os clássicos Nike Dunk Low.",
        price: "$29.99",
        type: "sapatilhas",
        condition: "Bom",
    },
...
if (product) {
    ...
    const productInfoHTML = `
        <div class="w3-display-container product-container" style="font-family:'Montserrat',sans-serif">
            <a href="${product.type}.html" class="w3-display-topleft" style="margin: 30px">Voltar ao Catálogo</a>
            <img src="${product.image}" alt="${product.name}">
            <div class="product-txt-container w3-display-topright">
                <h2 style="font-weight: 600">${product.name}</h2>
                <p>${product.description}</p>
                <p style="font-weight: 600">Condição: ${product.condition}</p>
                <p style="font-weight: 600">Preço: ${product.price}</p>
            </div>
